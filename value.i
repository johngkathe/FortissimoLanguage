...
# 32 "<command-line>" 2
# 1 "Bytecode/value/value.c"
# 1 "Bytecode/value/value.h" 1

#define value_h 

# 1 "Bytecode/value/../../common/common.h" 1
...
# 5 "Bytecode/value/../../common/common.h" 2
...
# 6 "Bytecode/value/../../common/common.h" 2
...
# 7 "Bytecode/value/../../common/common.h" 2

#define DEBUG_PRINT_CODE 
#define DEBUG_TRACE_EXECUTION 

#define UINT8_COUNT (UINT8_MAX + 1)
# 5 "Bytecode/value/value.h" 2
...
# 8 "Bytecode/value/value.h" 2


# 9 "Bytecode/value/value.h"
typedef struct Obj Obj;
typedef struct ObjString ObjString;
# 56 "Bytecode/value/value.h"
typedef enum {
    VAL_UNDEFINED,
    VAL_NIL,
    VAL_BOOL,
...
# 148 "Bytecode/value/value.h" 3 4
_Bool 
# 148 "Bytecode/value/value.h"
    valuesEqual(Value a, Value b);
void initValueArray(ValueArray* array);
void writeValueArray(ValueArray* array, Value value);
void freeValueArray(ValueArray* array);
void printValue(Value value);
# 2 "Bytecode/value/value.c" 2
# 1 "Bytecode/value/../memory/memory.h" 1

#define memory_h 

# 1 "Bytecode/value/../memory/../../common/common.h" 1
# 5 "Bytecode/value/../memory/memory.h" 2
# 1 "Bytecode/value/../memory/../../Language/object/object.h" 1

#define object_h 

# 1 "Bytecode/value/../memory/../../Language/object/../../common/common.h" 1
# 5 "Bytecode/value/../memory/../../Language/object/object.h" 2
# 1 "Bytecode/value/../memory/../../Language/object/../../Bytecode/value/value.h" 1
# 6 "Bytecode/value/../memory/../../Language/object/object.h" 2
...
static inline 
# 36 "Bytecode/value/../memory/../../Language/object/object.h" 3 4
             _Bool 
# 36 "Bytecode/value/../memory/../../Language/object/object.h"
                  isObjType(Value value, ObjType type){
    return ((value).type == VAL_OBJ) && ((value).as.obj)->type == type;
}
# 6 "Bytecode/value/../memory/memory.h" 2
...
void freeObjects();
# 3 "Bytecode/value/value.c" 2
# 1 "Bytecode/value/../../Language/object/object.h" 1
# 4 "Bytecode/value/value.c" 2
...
# 6 "Bytecode/value/value.c" 2



_Bool 
# 9 "Bytecode/value/value.c"
    valuesEqual(Value a, Value b){
    if(a.type != b.type) return 
# 10 "Bytecode/value/value.c" 3 4
                               0
# 10 "Bytecode/value/value.c"
                                    ;
    switch(a.type){
        case VAL_NIL: return 
...
void initValueArray(ValueArray* array){
    array->values = 
# 31 "Bytecode/value/value.c" 3 4
                   ((void *)0)
# 31 "Bytecode/value/value.c"
                       ;
    array->capacity = 0;
    array->count = 0;
}
