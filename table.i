...
# 32 "<command-line>" 2
# 1 "Language/table/table.c"
# 1 "Language/table/../../Bytecode/memory/memory.h" 1

#define memory_h 

# 1 "Language/table/../../Bytecode/memory/../../common/common.h" 1
...
# 5 "Language/table/../../Bytecode/memory/../../common/common.h" 2
...
# 6 "Language/table/../../Bytecode/memory/../../common/common.h" 2
...
# 7 "Language/table/../../Bytecode/memory/../../common/common.h" 2

#define DEBUG_PRINT_CODE 
#define DEBUG_TRACE_EXECUTION 

#define UINT8_COUNT (UINT8_MAX + 1)
# 5 "Language/table/../../Bytecode/memory/memory.h" 2
# 1 "Language/table/../../Bytecode/memory/../../Language/object/object.h" 1

#define object_h 

# 1 "Language/table/../../Bytecode/memory/../../Language/object/../../common/common.h" 1
# 5 "Language/table/../../Bytecode/memory/../../Language/object/object.h" 2
# 1 "Language/table/../../Bytecode/memory/../../Language/object/../../Bytecode/value/value.h" 1

#define value_h 

# 1 "Language/table/../../Bytecode/memory/../../Language/object/../../Bytecode/value/../../common/common.h" 1
# 5 "Language/table/../../Bytecode/memory/../../Language/object/../../Bytecode/value/value.h" 2
...
# 8 "Language/table/../../Bytecode/memory/../../Language/object/../../Bytecode/value/value.h" 2


# 9 "Language/table/../../Bytecode/memory/../../Language/object/../../Bytecode/value/value.h"
typedef struct Obj Obj;
typedef struct ObjString ObjString;
# 56 "Language/table/../../Bytecode/memory/../../Language/object/../../Bytecode/value/value.h"
typedef enum {
    VAL_UNDEFINED,
    VAL_NIL,
    VAL_BOOL,
...
# 77 "Language/table/../../Bytecode/memory/../../Language/object/../../Bytecode/value/value.h" 3 4
       _Bool 
# 77 "Language/table/../../Bytecode/memory/../../Language/object/../../Bytecode/value/value.h"
            boolean;
        int8_t i8;
        uint8_t u8;
        int16_t i16;
...
# 148 "Language/table/../../Bytecode/memory/../../Language/object/../../Bytecode/value/value.h" 3 4
_Bool 
# 148 "Language/table/../../Bytecode/memory/../../Language/object/../../Bytecode/value/value.h"
    valuesEqual(Value a, Value b);
void initValueArray(ValueArray* array);
void writeValueArray(ValueArray* array, Value value);
void freeValueArray(ValueArray* array);
void printValue(Value value);
# 6 "Language/table/../../Bytecode/memory/../../Language/object/object.h" 2
...
static inline 
# 36 "Language/table/../../Bytecode/memory/../../Language/object/object.h" 3 4
             _Bool 
# 36 "Language/table/../../Bytecode/memory/../../Language/object/object.h"
                  isObjType(Value value, ObjType type){
    return ((value).type == VAL_OBJ) && ((value).as.obj)->type == type;
}
# 6 "Language/table/../../Bytecode/memory/memory.h" 2
...
void freeObjects();
# 2 "Language/table/table.c" 2
# 1 "Language/table/../../Bytecode/value/value.h" 1
# 3 "Language/table/table.c" 2
# 1 "Language/table/../object/object.h" 1
# 4 "Language/table/table.c" 2
# 1 "Language/table/table.h" 1

#define table_h 

# 1 "Language/table/../../common/common.h" 1
# 5 "Language/table/table.h" 2


# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stddef.h" 1 3 4
# 8 "Language/table/table.h" 2
...
# 23 "Language/table/table.h" 3 4
_Bool 
# 23 "Language/table/table.h"
    tableSet(Table* table, ObjString* key, Value value);
void tableAddAll(Table* from, Table* to);

# 25 "Language/table/table.h" 3 4
_Bool 
# 25 "Language/table/table.h"
    tableGet(Table* table, ObjString* key, Value* value);

# 26 "Language/table/table.h" 3 4
_Bool 
# 26 "Language/table/table.h"
...
# 5 "Language/table/table.c" 2

# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stddef.h" 1 3 4
# 7 "Language/table/table.c" 2
...
# 9 "Language/table/table.c" 2


#define TABLE_MAX_LOAD 0.75


# 13 "Language/table/table.c"
void initTable(Table* table){
    table->count = 0;
    table->capacity = 0;
    table->entries = 
# 16 "Language/table/table.c" 3 4
                    ((void *)0)
# 16 "Language/table/table.c"
                        ;
}
...
static Entry* findEntry(Entry* entries, size_t capacity, ObjString* key){
    ...
    Entry* tombstone = 
# 26 "Language/table/table.c" 3 4
                      ((void *)0)
# 26 "Language/table/table.c"
                          ;

    for(;;){
        Entry* entry = &entries[index];
        if(entry->key == 
# 30 "Language/table/table.c" 3 4
                        ((void *)0)
# 30 "Language/table/table.c"
                            ){
            if(((entry->value).type == VAL_NIL)){
                return tombstone != 
# 32 "Language/table/table.c" 3 4
                                   ((void *)0) 
# 32 "Language/table/table.c"
                                        ? tombstone : entry;
            } else {
             if(tombstone == 
# 34 "Language/table/table.c" 3 4
                            ((void *)0)
# 34 "Language/table/table.c"
                                ) tombstone = entry;
            }
...
# 45 "Language/table/table.c" 3 4
                    ((void *)0)
# 45 "Language/table/table.c"
                    , 0, sizeof(Entry) * (capacity));
    for(ptrdiff_t i = 0; i < capacity; i++){
        entries[i].key = 
# 47 "Language/table/table.c" 3 4
                        ((void *)0)
# 47 "Language/table/table.c"
                            ;
        entries[i].value = ((Value){VAL_NIL, {.f64 = 0}});
    }
    ...
    for(ptrdiff_t i = 0; i < table->capacity; i++){
        ...
        if(entry->key == 
# 54 "Language/table/table.c" 3 4
                        ((void *)0)
# 54 "Language/table/table.c"
                            ) continue;
...
# 67 "Language/table/table.c" 3 4
_Bool 
# 67 "Language/table/table.c"
    tableSet(Table* table, ObjString* key, Value value){
...
# 74 "Language/table/table.c" 3 4
   _Bool 
# 74 "Language/table/table.c"
        isNewKey = entry->key == 
# 74 "Language/table/table.c" 3 4
                                 ((void *)0)
# 74 "Language/table/table.c"
...
void tableAddAll(Table* from, Table* to){
    for(ptrdiff_t i = 0; i < from->capacity; i++){
        ...
        if(entry->key != 
# 85 "Language/table/table.c" 3 4
                        ((void *)0)
# 85 "Language/table/table.c"
...
# 90 "Language/table/table.c" 3 4
                                ((void *)0)
# 90 "Language/table/table.c"
                                    ;
    ...
    for(;;){
        ...
        if(entry->key == 
# 95 "Language/table/table.c" 3 4
                        ((void *)0)
# 95 "Language/table/table.c"
                            ){
            if(((entry->value).type == VAL_NIL)) return 
# 96 "Language/table/table.c" 3 4
                                           ((void *)0)
# 96 "Language/table/table.c"
                                               ;
...
# 105 "Language/table/table.c" 3 4
_Bool 
# 105 "Language/table/table.c"
    tableGet(Table* table, ObjString* key, Value* value){
    if(table->count == 0) return 
# 106 "Language/table/table.c" 3 4
                                0
# 106 "Language/table/table.c"
                                     ;

    Entry* entry = findEntry(table->entries, table->capacity, key);
    if(entry->key == 
# 109 "Language/table/table.c" 3 4
                    ((void *)0)
# 109 "Language/table/table.c"
                        ) return 
# 109 "Language/table/table.c" 3 4
                                 0
# 109 "Language/table/table.c"
    ...
    *value = entry->value;
    return 
# 112 "Language/table/table.c" 3 4
          1
# 112 "Language/table/table.c"
              ;
}


# 115 "Language/table/table.c" 3 4
_Bool 
# 115 "Language/table/table.c"
    tableDelete(Table* table, ObjString* key){
    if(table->count == 0) return 
# 116 "Language/table/table.c" 3 4
                                0
# 116 "Language/table/table.c"
                                     ;


    Entry* entry = findEntry(table->entries, table->capacity, key);
    if(entry->key == 
# 120 "Language/table/table.c" 3 4
                    ((void *)0)
# 120 "Language/table/table.c"
                        ) return 
# 120 "Language/table/table.c" 3 4
                                 0
# 120 "Language/table/table.c"
    ...
    entry->key = 
# 123 "Language/table/table.c" 3 4
                ((void *)0)
# 123 "Language/table/table.c"
                    ;
    entry->value = ((Value){VAL_BOOL, {.boolean = 
# 124 "Language/table/table.c" 3 4
                  1
# 124 "Language/table/table.c"
                  }});
    return 
# 125 "Language/table/table.c" 3 4
          1
# 125 "Language/table/table.c"
              ;
}
