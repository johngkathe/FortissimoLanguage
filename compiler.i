# 1 "Compilation/compiler/compiler.c"
...
# 32 "<command-line>" 2
# 1 "Compilation/compiler/compiler.c"
# 1 "Compilation/compiler/../../Bytecode/value/value.h" 1

#define value_h 

# 1 "Compilation/compiler/../../Bytecode/value/../../common/common.h" 1
...
# 5 "Compilation/compiler/../../Bytecode/value/../../common/common.h" 2
...
# 6 "Compilation/compiler/../../Bytecode/value/../../common/common.h" 2
...
# 7 "Compilation/compiler/../../Bytecode/value/../../common/common.h" 2

#define DEBUG_PRINT_CODE 
#define DEBUG_TRACE_EXECUTION 

#define UINT8_COUNT (UINT8_MAX + 1)
# 5 "Compilation/compiler/../../Bytecode/value/value.h" 2
...
# 8 "Compilation/compiler/../../Bytecode/value/value.h" 2


# 9 "Compilation/compiler/../../Bytecode/value/value.h"
typedef struct Obj Obj;
typedef struct ObjString ObjString;
# 56 "Compilation/compiler/../../Bytecode/value/value.h"
typedef enum {
    VAL_UNDEFINED,
    VAL_NIL,
    VAL_BOOL,
...
# 77 "Compilation/compiler/../../Bytecode/value/value.h" 3 4
       _Bool 
...
# 148 "Compilation/compiler/../../Bytecode/value/value.h" 3 4
_Bool 
# 148 "Compilation/compiler/../../Bytecode/value/value.h"
    valuesEqual(Value a, Value b);
void initValueArray(ValueArray* array);
void writeValueArray(ValueArray* array, Value value);
void freeValueArray(ValueArray* array);
void printValue(Value value);
# 2 "Compilation/compiler/compiler.c" 2
# 1 "Compilation/compiler/../../common/common.h" 1
# 3 "Compilation/compiler/compiler.c" 2
# 1 "Compilation/compiler/compiler.h" 1

#define compiler_h 

# 1 "Compilation/compiler/../../Language/object/object.h" 1

#define object_h 

# 1 "Compilation/compiler/../../Language/object/../../common/common.h" 1
# 5 "Compilation/compiler/../../Language/object/object.h" 2
# 1 "Compilation/compiler/../../Language/object/../../Bytecode/value/value.h" 1
# 6 "Compilation/compiler/../../Language/object/object.h" 2
...
static inline 
# 36 "Compilation/compiler/../../Language/object/object.h" 3 4
             _Bool 
# 36 "Compilation/compiler/../../Language/object/object.h"
                  isObjType(Value value, ObjType type){
    return ((value).type == VAL_OBJ) && ((value).as.obj)->type == type;
}
# 5 "Compilation/compiler/compiler.h" 2
# 1 "Compilation/compiler/../../Tokenization/scanner/scanner.h" 1
...
Token scanToken();
# 6 "Compilation/compiler/compiler.h" 2
# 1 "Compilation/compiler/../../VirtualMachine/vm/vm.h" 1

#define vm_h 

# 1 "Compilation/compiler/../../VirtualMachine/vm/../../Bytecode/chunk/chunk.h" 1

#define chunk_h 

# 1 "Compilation/compiler/../../VirtualMachine/vm/../../Bytecode/chunk/../../common/common.h" 1
# 5 "Compilation/compiler/../../VirtualMachine/vm/../../Bytecode/chunk/chunk.h" 2
# 1 "Compilation/compiler/../../VirtualMachine/vm/../../Bytecode/chunk/../value/value.h" 1
# 6 "Compilation/compiler/../../VirtualMachine/vm/../../Bytecode/chunk/chunk.h" 2
...
# 5 "Compilation/compiler/../../VirtualMachine/vm/vm.h" 2
# 1 "Compilation/compiler/../../VirtualMachine/vm/../../Bytecode/value/value.h" 1
# 6 "Compilation/compiler/../../VirtualMachine/vm/vm.h" 2
# 1 "Compilation/compiler/../../VirtualMachine/vm/../../Language/table/table.h" 1

#define table_h 

# 1 "Compilation/compiler/../../VirtualMachine/vm/../../Language/table/../../common/common.h" 1
# 5 "Compilation/compiler/../../VirtualMachine/vm/../../Language/table/table.h" 2
# 1 "Compilation/compiler/../../VirtualMachine/vm/../../Language/table/../../Bytecode/value/value.h" 1
# 6 "Compilation/compiler/../../VirtualMachine/vm/../../Language/table/table.h" 2

# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stddef.h" 1 3 4
# 8 "Compilation/compiler/../../VirtualMachine/vm/../../Language/table/table.h" 2
...
# 23 "Compilation/compiler/../../VirtualMachine/vm/../../Language/table/table.h" 3 4
_Bool 
# 23 "Compilation/compiler/../../VirtualMachine/vm/../../Language/table/table.h"
    tableSet(Table* table, ObjString* key, Value value);
void tableAddAll(Table* from, Table* to);

# 25 "Compilation/compiler/../../VirtualMachine/vm/../../Language/table/table.h" 3 4
_Bool 
# 25 "Compilation/compiler/../../VirtualMachine/vm/../../Language/table/table.h"
    tableGet(Table* table, ObjString* key, Value* value);

# 26 "Compilation/compiler/../../VirtualMachine/vm/../../Language/table/table.h" 3 4
_Bool 
# 26 "Compilation/compiler/../../VirtualMachine/vm/../../Language/table/table.h"
...
# 7 "Compilation/compiler/../../VirtualMachine/vm/vm.h" 2
...
static 
# 41 "Compilation/compiler/../../VirtualMachine/vm/vm.h" 3 4
      _Bool 
# 41 "Compilation/compiler/../../VirtualMachine/vm/vm.h"
           isFalsey(Value value);
# 7 "Compilation/compiler/compiler.h" 2





# 11 "Compilation/compiler/compiler.h" 3 4
_Bool 
# 11 "Compilation/compiler/compiler.h"
    compile(const int8_t* source, Chunk* chunk);
Token scanToken();
# 4 "Compilation/compiler/compiler.c" 2





# 1 "Compilation/compiler/../../Bytecode/debug/debug.h" 1

#define debug_h 

# 1 "Compilation/compiler/../../Bytecode/debug/../chunk/chunk.h" 1
# 5 "Compilation/compiler/../../Bytecode/debug/debug.h" 2
...
void printValue(Value value);
# 10 "Compilation/compiler/compiler.c" 2
...
# 13 "Compilation/compiler/compiler.c" 2
...
# 15 "Compilation/compiler/compiler.c" 2



# 17 "Compilation/compiler/compiler.c"
typedef struct {
    Token current;
    Token previous;
    
# 20 "Compilation/compiler/compiler.c" 3 4
   _Bool 
# 20 "Compilation/compiler/compiler.c"
        hadError;
    
# 21 "Compilation/compiler/compiler.c" 3 4
   _Bool 
# 21 "Compilation/compiler/compiler.c"
        panicMode;
} Parser;
...
# 39 "Compilation/compiler/compiler.c" 3 4
                       _Bool 
# 39 "Compilation/compiler/compiler.c"
                            canAssign);
...
typedef struct {
    Local locals[(
# 53 "Compilation/compiler/compiler.c" 3 4
                (255) 
# 53 "Compilation/compiler/compiler.c"
                + 1)];
    int16_t localCount;
    int16_t scopeDepth;
} Compiler;
...
Parser parser;
Compiler* current = 
# 59 "Compilation/compiler/compiler.c" 3 4
                   ((void *)0)
# 59 "Compilation/compiler/compiler.c"
                       ;
...
static void errorAt(Token* token, const char* message){
    ...
    parser.panicMode = 
# 68 "Compilation/compiler/compiler.c" 3 4
                      1
# 68 "Compilation/compiler/compiler.c"
                          ;
    fprintf(
# 69 "Compilation/compiler/compiler.c" 3 4
           stderr
...
# 75 "Compilation/compiler/compiler.c" 3 4
               stderr
# 75 "Compilation/compiler/compiler.c"
                     , " at '%.*s'", token->length, token->start);
    }

    fprintf(
# 78 "Compilation/compiler/compiler.c" 3 4
           stderr
# 78 "Compilation/compiler/compiler.c"
                 , ": %s\n", message);
    parser.hadError = 
# 79 "Compilation/compiler/compiler.c" 3 4
                     1
# 79 "Compilation/compiler/compiler.c"
                         ;
}
