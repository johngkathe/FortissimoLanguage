...
# 32 "<command-line>" 2
# 1 "Bytecode/memory/memory.c"
# 1 "Bytecode/memory/memory.h" 1

#define memory_h 

# 1 "Bytecode/memory/../../common/common.h" 1
...
# 5 "Bytecode/memory/../../common/common.h" 2
...
# 6 "Bytecode/memory/../../common/common.h" 2
...
# 7 "Bytecode/memory/../../common/common.h" 2

#define DEBUG_PRINT_CODE 
#define DEBUG_TRACE_EXECUTION 

#define UINT8_COUNT (UINT8_MAX + 1)
# 5 "Bytecode/memory/memory.h" 2
# 1 "Bytecode/memory/../../Language/object/object.h" 1

#define object_h 

# 1 "Bytecode/memory/../../Language/object/../../common/common.h" 1
# 5 "Bytecode/memory/../../Language/object/object.h" 2
# 1 "Bytecode/memory/../../Language/object/../../Bytecode/value/value.h" 1

#define value_h 

# 1 "Bytecode/memory/../../Language/object/../../Bytecode/value/../../common/common.h" 1
# 5 "Bytecode/memory/../../Language/object/../../Bytecode/value/value.h" 2
...
# 8 "Bytecode/memory/../../Language/object/../../Bytecode/value/value.h" 2


# 9 "Bytecode/memory/../../Language/object/../../Bytecode/value/value.h"
typedef struct Obj Obj;
typedef struct ObjString ObjString;
# 56 "Bytecode/memory/../../Language/object/../../Bytecode/value/value.h"
typedef enum {
    VAL_UNDEFINED,
    VAL_NIL,
    VAL_BOOL,
...
# 77 "Bytecode/memory/../../Language/object/../../Bytecode/value/value.h" 3 4
       _Bool 
# 77 "Bytecode/memory/../../Language/object/../../Bytecode/value/value.h"
            boolean;
        int8_t ch;
        uint8_t uCh;
        int16_t in;
...
# 148 "Bytecode/memory/../../Language/object/../../Bytecode/value/value.h" 3 4
_Bool 
# 148 "Bytecode/memory/../../Language/object/../../Bytecode/value/value.h"
    valuesEqual(Value a, Value b);
void initValueArray(ValueArray* array);
void writeValueArray(ValueArray* array, Value value);
void freeValueArray(ValueArray* array);
void printValue(Value value);
# 6 "Bytecode/memory/../../Language/object/object.h" 2
...
static inline 
# 36 "Bytecode/memory/../../Language/object/object.h" 3 4
             _Bool 
# 36 "Bytecode/memory/../../Language/object/object.h"
                  isObjType(Value value, ObjType type){
    return ((value).type == VAL_OBJ) && ((value).as.obj)->type == type;
}
# 6 "Bytecode/memory/memory.h" 2
...
void freeObjects();
# 2 "Bytecode/memory/memory.c" 2
# 1 "Bytecode/memory/../../VirtualMachine/vm/vm.h" 1

#define vm_h 

# 1 "Bytecode/memory/../../VirtualMachine/vm/../../Bytecode/chunk/chunk.h" 1

#define chunk_h 

# 1 "Bytecode/memory/../../VirtualMachine/vm/../../Bytecode/chunk/../../common/common.h" 1
# 5 "Bytecode/memory/../../VirtualMachine/vm/../../Bytecode/chunk/chunk.h" 2
# 1 "Bytecode/memory/../../VirtualMachine/vm/../../Bytecode/chunk/../value/value.h" 1
# 6 "Bytecode/memory/../../VirtualMachine/vm/../../Bytecode/chunk/chunk.h" 2
...
# 5 "Bytecode/memory/../../VirtualMachine/vm/vm.h" 2
# 1 "Bytecode/memory/../../VirtualMachine/vm/../../Bytecode/value/value.h" 1
# 6 "Bytecode/memory/../../VirtualMachine/vm/vm.h" 2
# 1 "Bytecode/memory/../../VirtualMachine/vm/../../Language/table/table.h" 1

#define table_h 

# 1 "Bytecode/memory/../../VirtualMachine/vm/../../Language/table/../../common/common.h" 1
# 5 "Bytecode/memory/../../VirtualMachine/vm/../../Language/table/table.h" 2
# 1 "Bytecode/memory/../../VirtualMachine/vm/../../Language/table/../../Bytecode/value/value.h" 1
# 6 "Bytecode/memory/../../VirtualMachine/vm/../../Language/table/table.h" 2

# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stddef.h" 1 3 4
# 8 "Bytecode/memory/../../VirtualMachine/vm/../../Language/table/table.h" 2
...
# 23 "Bytecode/memory/../../VirtualMachine/vm/../../Language/table/table.h" 3 4
_Bool 
# 23 "Bytecode/memory/../../VirtualMachine/vm/../../Language/table/table.h"
    tableSet(Table* table, ObjString* key, Value value);
void tableAddAll(Table* from, Table* to);

# 25 "Bytecode/memory/../../VirtualMachine/vm/../../Language/table/table.h" 3 4
_Bool 
# 25 "Bytecode/memory/../../VirtualMachine/vm/../../Language/table/table.h"
    tableGet(Table* table, ObjString* key, Value* value);

# 26 "Bytecode/memory/../../VirtualMachine/vm/../../Language/table/table.h" 3 4
_Bool 
# 26 "Bytecode/memory/../../VirtualMachine/vm/../../Language/table/table.h"
...
# 7 "Bytecode/memory/../../VirtualMachine/vm/vm.h" 2
...
static 
# 41 "Bytecode/memory/../../VirtualMachine/vm/vm.h" 3 4
      _Bool 
# 41 "Bytecode/memory/../../VirtualMachine/vm/vm.h"
           isFalsey(Value value);
# 3 "Bytecode/memory/memory.c" 2
...
# 6 "Bytecode/memory/memory.c" 2


# 7 "Bytecode/memory/memory.c"
void* reallocate(void* pointer, size_t oldSize, size_t newSize){
    if(newSize == 0){
        free(pointer);
        return 
# 10 "Bytecode/memory/memory.c" 3 4
              ((void *)0)
# 10 "Bytecode/memory/memory.c"
                  ;
    }

    void* result = realloc(pointer, newSize);
    if(result == 
# 14 "Bytecode/memory/memory.c" 3 4
                ((void *)0)
# 14 "Bytecode/memory/memory.c"
                    ) exit(1);
    if(newSize > oldSize)
...
static void freeObject(Obj* object){
    switch(object->type){
        case OBJ_STRING:{
            ...
            reallocate(string->chars, sizeof(int8_t) * (string->length + 1), 0);
...
void freeObjects(){
    ...
    while(object != 
# 33 "Bytecode/memory/memory.c" 3 4
                   ((void *)0)
# 33 "Bytecode/memory/memory.c"
                       ){
