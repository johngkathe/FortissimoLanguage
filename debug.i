...
# 32 "<command-line>" 2
# 1 "Bytecode/debug/debug.c"
# 1 "Bytecode/debug/debug.h" 1

#define debug_h 

# 1 "Bytecode/debug/../chunk/chunk.h" 1

#define chunk_h 

# 1 "Bytecode/debug/../chunk/../../common/common.h" 1
...
# 5 "Bytecode/debug/../chunk/../../common/common.h" 2
...
# 6 "Bytecode/debug/../chunk/../../common/common.h" 2
...
# 7 "Bytecode/debug/../chunk/../../common/common.h" 2

#define DEBUG_PRINT_CODE 
#define DEBUG_TRACE_EXECUTION 

#define UINT8_COUNT (UINT8_MAX + 1)
# 5 "Bytecode/debug/../chunk/chunk.h" 2
# 1 "Bytecode/debug/../chunk/../value/value.h" 1

#define value_h 

# 1 "Bytecode/debug/../chunk/../value/../../common/common.h" 1
# 5 "Bytecode/debug/../chunk/../value/value.h" 2
...
# 8 "Bytecode/debug/../chunk/../value/value.h" 2


# 9 "Bytecode/debug/../chunk/../value/value.h"
typedef struct Obj Obj;
typedef struct ObjString ObjString;
# 56 "Bytecode/debug/../chunk/../value/value.h"
typedef enum {
    VAL_UNDEFINED,
    VAL_NIL,
    VAL_BOOL,
...
# 77 "Bytecode/debug/../chunk/../value/value.h" 3 4
       _Bool 
# 77 "Bytecode/debug/../chunk/../value/value.h"
            boolean;
        int8_t ch;
        uint8_t uCh;
        int16_t in;
...
# 148 "Bytecode/debug/../chunk/../value/value.h" 3 4
_Bool 
# 148 "Bytecode/debug/../chunk/../value/value.h"
    valuesEqual(Value a, Value b);
void initValueArray(ValueArray* array);
void writeValueArray(ValueArray* array, Value value);
void freeValueArray(ValueArray* array);
void printValue(Value value);
# 6 "Bytecode/debug/../chunk/chunk.h" 2
...
void printValue(Value value);
# 2 "Bytecode/debug/debug.c" 2
# 1 "Bytecode/debug/../value/value.h" 1
# 3 "Bytecode/debug/debug.c" 2
...
# 8 "Bytecode/debug/debug.c" 2


# 9 "Bytecode/debug/debug.c"
void disassembleChunk(Chunk* chunk, const int8_t* name){
    printf("== %s ==\n", name);
...
static int16_t constantInstruction(const int8_t* name, Chunk* chunk, int16_t offset){
    ...
    if(!chunk->constants.values || &chunk->constants.values[constant] == 
# 85 "Bytecode/debug/debug.c" 3 4
                                                                        ((void *)0)
# 85 "Bytecode/debug/debug.c"
                                                                            ) printf("NULL");
...
static int16_t longConstantInstruction(const int8_t* name, Chunk* chunk, int16_t offset){
    ...
    printf("%-16s %4d '", name, constant);
    if(!chunk->constants.values || &chunk->constants.values[constant] == 
# 95 "Bytecode/debug/debug.c" 3 4
                                                                        ((void *)0)
# 95 "Bytecode/debug/debug.c"
                                                                            ) printf("NULL");
    else printValue(chunk->constants.values[constant]);
    printf("'\n");
    return offset + 4;
